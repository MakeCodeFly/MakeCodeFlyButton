package com.makecodefly.statedbutton.widget;
...
import com.makecodefly.statedbutton.R;
...
public class MakeCodeFlyButton extends AppCompatButton {
    ...
    public MakeCodeFlyButton(Context context) {
        this(context, null);
    }

    public MakeCodeFlyButton(Context context, AttributeSet attrs) {
        this(context, attrs, android.support.v7.appcompat.R.attr.buttonStyle);
    }

    public MakeCodeFlyButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setup(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.MakeCodeFlyButton);
        ...
        mNormalTextColor = a.getColor(R.styleable.MakeCodeFlyButton_normalTextColor, mDefaultNormalTextColor);
        mPressedTextColor = a.getColor(R.styleable.MakeCodeFlyButton_pressedTextColor, mDefaultPressedTextColor);
        mUnableTextColor = a.getColor(R.styleable.MakeCodeFlyButton_unableTextColor, mDefaultUnableTextColor);
        setTextColor();

        //set animation duration
        mDuration = a.getInteger(R.styleable.MakeCodeFlyButton_animationDuration, mDuration);
        mStateBackground.setEnterFadeDuration(mDuration);
        mStateBackground.setExitFadeDuration(mDuration);

        //set background color
        mNormalBackgroundColor = a.getColor(R.styleable.MakeCodeFlyButton_normalBackgroundColor, 0);
        mPressedBackgroundColor = a.getColor(R.styleable.MakeCodeFlyButton_pressedBackgroundColor, 0);
        mUnableBackgroundColor = a.getColor(R.styleable.MakeCodeFlyButton_unableBackgroundColor, 0);
        ...
        //set radius
        mRadius = a.getDimensionPixelSize(R.styleable.MakeCodeFlyButton_radius, 0);
        mRound = a.getBoolean(R.styleable.MakeCodeFlyButton_round, false);
        ...
        //set stroke
        mStrokeDashWidth = a.getDimensionPixelSize(R.styleable.MakeCodeFlyButton_strokeDashWidth, 0);
        mStrokeDashGap = a.getDimensionPixelSize(R.styleable.MakeCodeFlyButton_strokeDashWidth, 0);
        mNormalStrokeWidth = a.getDimensionPixelSize(R.styleable.MakeCodeFlyButton_normalStrokeWidth, 0);
        mPressedStrokeWidth = a.getDimensionPixelSize(R.styleable.MakeCodeFlyButton_pressedStrokeWidth, 0);
        mUnableStrokeWidth = a.getDimensionPixelSize(R.styleable.MakeCodeFlyButton_unableStrokeWidth, 0);
        mNormalStrokeColor = a.getColor(R.styleable.MakeCodeFlyButton_normalStrokeColor, 0);
        mPressedStrokeColor = a.getColor(R.styleable.MakeCodeFlyButton_pressedStrokeColor, 0);
        mUnableStrokeColor = a.getColor(R.styleable.MakeCodeFlyButton_unableStrokeColor, 0);
        setStroke();
